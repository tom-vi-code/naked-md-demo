...
export default function Tooltip({ text, children }: { text: string; children: ReactNode }) {
  ...
  return (
    ...
    >
      {children}
      <span
        className={`pointer-events-none absolute left-1/2 z-50 -translate-x-1/2 rounded-none border border-white/10 bg-[#282828] px-3.5 py-2.5 text-[12px] font-normal normal-case tracking-normal leading-relaxed text-slate-200 opacity-0 shadow-[0_8px_32px_rgba(0,0,0,0.5)] transition-opacity duration-150 group-hover/tip:opacity-100 ${
